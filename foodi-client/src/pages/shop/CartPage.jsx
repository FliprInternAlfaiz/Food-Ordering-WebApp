...
const CartPage = () => {
  ...
  if (!user) {
    return (
      <div className="max-w-screen-1xl container mx-auto xl:px-12 bg-gradient-to-r from-0% from-[#FAFAFA] to-[#FCFCFC] to-100%">
        <div className="py-36 flex flex-row items-center justify-center gap-8">
          <div className="flex-col px-4 space-y-2">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Please Login For Added{" "}
              <span className="text-green">to Cart Item</span>
            </h2>
          ...
          <tbody>
            {cartItems.map((item, index) => (
              <tr key={item._id}>
                ...
                <td>
                  <button
                    className="btn btn-xs bg-prigmayBG"
                  ...
                  <input
                    type="number"
                    value={item.quantity}
                    className="w-10 mx-2 text-center overflow-hidden appearance-none bg-prigmayBG"
                    readOnly
                  />
                  <button
                    className="btn btn-xs bg-prigmayBG"
        ...
        <div className="my-12 flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="md:w-1/2 space-y-3">
            ...
            <button
              ...
              className="btn bg-green text-white my-4"
            >
              Proceed to Checkout
            </button>
          </div>
